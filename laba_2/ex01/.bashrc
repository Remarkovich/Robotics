...
alias cubeide='/usr/bin/flatpak run --branch=stable --arch=x86_64 --command=stm32cubeide com.st.STM32CubeIDE'
# Alias definitions.
...
alias paralserv="ssh m.shevtsov@84.237.51.129 -p 10023"
